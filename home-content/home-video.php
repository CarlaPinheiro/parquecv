<article class="item">
	<?php if ( has_post_format( 'video' )) { echo "<div class='video-container'>" . parquecv_oembed() . "</div>"; } ?> 
	<div class="inner-item">
	<h2><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
	<div class="excerpt"><?php the_excerpt( '<span class="read-more">' . __( 'Read More &raquo;', 'parquecv' ) . '</span>' ); ?></div>
	</div>
