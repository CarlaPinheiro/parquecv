					...
					<div id="main" class="m-all t-2of3 d-5of7 cf" role="main">
						...
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<div class="main-content-area">
								...
								<p class="meta-cat">
									<?php
										$category_list = get_the_category_list( __( ', ', 'parquecv' ) );
										printf( esc_html('%s', 'parquecv'),
										$category_list
										);
									?>
								</p>
							...
							<?php if(has_tag()): ?>
							    <div class="tag-links">
							      <div class="clear"></div>
							      <?php esc_html_e('TAGS: ','parquecv'); ?>
							      <?php echo get_the_tag_list('',',','');?>
							    </div>
							 <?php endif; ?>

							<footer class="below-content-area">
								<?php if ( get_theme_mod('parquecv_author_area') ):
		                    	...
		                    	<?php if ( get_theme_mod('parquecv_related_posts') ):
			                    ...
			                    <div class="related-posts <?php echo esc_attr( $related_class ); ?>">
				                    <h3 class="section-title"><?php esc_html_e('Relacionados ','parquecv'); ?></h3>
				                    <div> 
					                            ...
					                            <div class="related-item">
					                              <div class="related-image">
						                              <a href="<?php the_permalink() ?>" rel="bookmark">
						                                <?php $image_thumb = parquecv_catch_that_image_thumb(); $gallery_thumb = parquecv_catch_gallery_image_thumb(); 
						...
						<?php else : ?>
							...
							<article id="post-not-found" class="hentry cf">
									<header class="article-header">
										<h1><?php esc_html_e( 'Oops, Post Not Found!', 'parquecv' ); ?></h1>
										<p><?php esc_html_e( 'Uh Oh. Something is missing. Try double checking things.', 'parquecv' ); ?></p>
									</header>
							</article>
